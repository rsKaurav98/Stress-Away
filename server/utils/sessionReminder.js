...
const sendReminderEmail = async (data) => {
  try {
    ...
    const mailOptions = {
      ...
      Just a quick reminder that your therapy session with StressAway is scheduled for tomorrow, ${data.appointmentDate} at ${data.appointmentTime} with [Therapist Name]. We're excited to connect with you and provide the support you need.<br/>
